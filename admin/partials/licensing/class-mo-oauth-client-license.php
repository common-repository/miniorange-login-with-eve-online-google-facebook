						...
						<div class="moc-licensing-plan card-body">
							...
							<div class="moc-licensing-plan-feature-list">
								<ul>
									...
									<li>&#10060;&emsp;<span class="text-muted">Protect complete site with SSO</span></li>
						...
						<div class="moc-licensing-plan card-body">
							...
							<div class="moc-licensing-plan-feature-list">
								<ul>
									...
									<li>&#9989;&emsp;Protect complete site with SSO</li>
						...
						<div class="row">
							...
							<div class="col span-1-of-3">
								<div class="plan-box">
									...
									<div>
										If you want to use bank transfer for the payment then contact us at <b><i><a href="mailto:oauthsupport@xecurify.com">oauthsupport@xecurify.com</a></i></b>  so that we can provide you the bank details.
									</div>
								</div>
							</div>
						</div>
